				...
				<div className="max-w-7xl mx-auto text-center relative">
					<div className="mb-8">
						...
						<p className="text-xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
							Citizn connects engaged citizens with responsive
							local government through our professional-grade
							infrastructure reporting platform. Make your voice
							heard and see real change happen.
						</p>
					</div>
					...
					<div className="max-w-4xl mx-auto">
						<Card
							className="group hover:shadow-2xl transition-all duration-500 border-2 hover:border-blue-300 cursor-pointer transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm"
						...
						>
							<CardHeader className="text-center pb-6">
								...
								<CardDescription className="text-gray-600 text-lg">
									Help improve your community by reporting and
									tracking infrastructure problems
								</CardDescription>
							</CardHeader>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-12">
						...
						<div className="text-center group">
							...
							<p className="text-gray-600 leading-relaxed">
								...
								updates as authorities work to resolve reported
								issues
							</p>
						</div>
						<div className="text-center group">
