...
export const AllIssues = () => {
  ...
  const filteredIssues = useMemo(() => {
    let filtered = issues.filter(issue => {
      ...
      if (locationFilter !== 'all' && issue.address) {
        ...
        extractedLocation =
          extractedLocation.charAt(0).toUpperCase() +
          extractedLocation.slice(1).toLowerCase();
    ...
    filtered.sort((a, b) => {
      switch (sortBy) {
        ...
        case 'location':
          ...
          return getLocationName(a.address || '').localeCompare(
            getLocationName(b.address || '')
          );
        default:
          return 0;
      }
  ...
  const handleUpdateIssue = async (
    issueId: string,
    updates: { status: string; severity?: string; resolution_notes?: string }
  ) => {
    updateIssue(
      { id: issueId, updates },
      {
  ...
  const handleAddIssue = () => {
    toast({
      title: 'Add Issue',
      description: 'Add issue functionality coming soon',
    });
  };

  return (
    <div className='mx-auto max-w-7xl px-4 py-6 pt-16 sm:px-6 sm:py-8 lg:px-8 lg:pt-8'>
      {/* Header Section */}
      <div className='mb-6 sm:mb-8'>
        <div className='mb-2 text-xl font-normal text-gray-900 sm:text-xl lg:mb-3 lg:text-3xl'>
          All Issues
        </div>
      </div>
          ...
          <div className='flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <AdminIssueActions
                ...
                onShare={() => toast({ title: 'Share', description: 'Share functionality coming soon' })}
